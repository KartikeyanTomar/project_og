            ...
            <section className="aartibox">
                <div className="other-container">
                    <div className="aarti-heading">
                        <h1 className="section-heading-primary">Aarti</h1>
                    </div>
                    <div className="aarti-options">
                        <div className="aarti-cards">
                            <a href="/test_redirect" target="_blank" className="Aarti-more">

                                <Aarticard
                                    image={kaliImage}
                                    alt="kali Arti"
                                    aartiName="Kali Aarti"
                                />
                            </a>
                            <a href="/test_redirect" target="_blank" className="Aarti-more">
                                <Aarticard
